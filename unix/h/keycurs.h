/*
 * Standard function key definitions used by curses to indicate
 * special keys the user has pressed.
 */
#ifndef KEY_BREAK

#define KEY_BREAK	0401		/* break key (unreliable) */
#define KEY_UP		0402		/* Up Arrow key */
#define KEY_DOWN	0403		/* Down Arrow key */
#define KEY_LEFT	0404		/* Left Arrow key */
#define KEY_RIGHT	0405		/* Right Arrow key */
#define KEY_HOME	0406		/* Home cursor key */
...
#define	KEY_PREVIOUS	0562		/* prev(ious) object key */
...
#define	KEY_SOPTIONS	0616		/* shifted options key */
#define	KEY_SPREVIOUS	0617		/* shifted previous key */
#define	KEY_SPRINT	0620		/* shifted print key */
#define	KEY_SREDO	0621		/* shifted redo key */
#define	KEY_SREPLACE	0622		/* shifted replace key */
#define	KEY_SRIGHT	0624		/* shifted resume key */
#define	KEY_SRSUME	0623		/* shifted right arrow key */
#define	KEY_SSAVE	0625		/* shifted save key */
#define	KEY_SSUSPEND	0626		/* shifted suspend key */
#define	KEY_SUNDO	0627		/* shifted undo key */
#define	KEY_SUSPEND	0630		/* suspend key */
#define	KEY_UNDO	0631		/* undo key */
