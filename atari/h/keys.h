...
/*
 * "keyicon.h" is specially kludged for Alice and is otherwise useless.
 * Damn QNX preprocessor runs out of memory otherwise.
 */
#include "keyicon.h"
...
#define	PFKEYNAMES	"F1:Tokens F2:Help F3:Ids F4:Menu $:Select"
#include "keycurs.h"
