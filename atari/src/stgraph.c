...
int *y;
{
	...
	switch( _currSystem ) {
		...
		case CO_PIXEL:
			return;
		case CO_NORMAL:
			width = height = min( workrect.g_w, workrect.g_h );
			dwidth = dheight = 32767L;
			break;
		case CO_REVNORMAL:
			width = height = max( workrect.g_w, workrect.g_h );
			dwidth = dheight = 32767L;
			break;
		case CO_STRETCH:
			width = workrect.g_w;
...
int *y;
{
	...
	switch( _currSystem ) {
		...
		case CO_PIXEL:
			return;
		case CO_NORMAL:
			width = height = min( scr_area.g_w, scr_area.g_h );
			dwidth = dheight = 32767L;
			break;
		case CO_REVNORMAL:
			width = height = max( scr_area.g_w, scr_area.g_h );
			dwidth = dheight = 32767L;
			break;
		case CO_STRETCH:
			width = scr_area.g_w;
